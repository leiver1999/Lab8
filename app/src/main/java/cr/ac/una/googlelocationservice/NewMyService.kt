...
class NewMyService : Service() {
    ...
    override fun onCreate() {
        ...
        Places.initialize(applicationContext, "AIzaSyCu3nGsfBHdkbzDqtm3DRcPY9F6YPtAFHM")
        ...
        placeResponse.addOnCompleteListener { task ->
            if (task.isSuccessful) {
                ...
                topPlaces.forEach { placeLikelihood ->
                    ...
                    Log.e("AAA", "Lugar: ${placeLikelihood.place.name}, Probabilidad: ${placeLikelihood.likelihood}")
